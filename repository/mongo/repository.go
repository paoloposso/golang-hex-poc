...
func NewMongoRepository(mongoUrl, database string, mongoTimeout int) (shortener.RedirectRepository, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "repository.Redirect.NewMongoRepository")
	}
	repo.client = client
	return repo, nil
}
